        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projectIds.map((id) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">{projects[id].title}</h3>
                <p className="text-gray-600 dark:text-gray-300">{projects[id].description}</p>
                <div className="mt-4 flex flex-wrap gap-2">
                  {projects[id].techStack.map((tech, techIndex) => (
                    <span 
                      key={techIndex}
